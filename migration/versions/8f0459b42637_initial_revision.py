...
Revision ID: 8f0459b42637
Revises: 
Create Date: 2024-11-10 17:22:21.804933
...
def upgrade() -> None:
    ...
    sa.Column('profession', sa.Enum('DEVELOPER', 'DESIGNER', 'MANAGER', 'TEACHER', 'DOCTOR', 'ENGINEER', 'MARKETER', 'WRITER', 'ARTIST', 'LAWYER', 'SCIENTIST', 'NURSE', 'UNEMPLOYED', name='professionenum', create_type=False), nullable=False),
