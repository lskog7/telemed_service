...
Revision ID: 3098738acf6e
Revises: 
Create Date: 2024-11-10 00:31:20.644732
...
def upgrade() -> None:
    ...
    sa.Column('profession', sa.Enum('DEVELOPER', 'DESIGNER', 'MANAGER', 'TEACHER', 'DOCTOR', 'ENGINEER', 'MARKETER', 'WRITER', 'ARTIST', 'LAWYER', 'SCIENTIST', 'NURSE', 'UNEMPLOYED', name='professionenum', create_type=False), default='UNEMPLOYED', nullable=False),
    ...
    sa.Column('status', sa.Enum('PUBLISHED', 'DELETED', 'UNDER_MODERATION', 'DRAFT', 'SCHEDULED', name='statuspostenum', create_type=False), server_default=sa.text("'DRAFT'"), nullable=False),
